        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="inline-block mb-6">
              <img
                src="/logo/Masakali-RestoBar.png"
                alt="Masakali"
          ...
          <div>
            ...
            <div className="mt-8">
              ...
              <div className="space-y-2">
                <a href="tel:+16137896777" className="text-neutral-500 dark:text-neutral-400 text-sm hover:text-neutral-900 dark:hover:text-white transition-colors flex items-center gap-2">
                  <Phone size={14} /> (613) 789-6777
                </a>
                <a href="mailto:infomasakaliottawa@gmail.com" className="text-neutral-500 dark:text-neutral-400 text-sm hover:text-neutral-900 dark:hover:text-white transition-colors flex items-center gap-2">
                  <Mail size={14} /> infomasakaliottawa@gmail.com
                </a>
              </div>
            </div>
          </div>
