      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
          ...
          >
            ...
            <br />
            <span className="text-gold-gradient">Indian Restobar</span>
          </motion.h1>
          ...
          >
            ...
            <a href="tel:+16137896777" className="text-amber-400 font-semibold hover:text-amber-300 transition-colors">
              (613) 789-6777
            </a>
          </motion.p>
          ...
          >
            <a
              href="https://www.clover.com/online-ordering/masakali-indian-restobar-ottawa"
              target="_blank"
        ...
        <div className="max-w-5xl mx-auto px-4 relative z-10">
          <AnimatedSection className="text-center">
            ...
            <p className="text-neutral-600 dark:text-neutral-400 text-lg mb-8 max-w-2xl mx-auto">
              Masakali Indian Restobar is now serving in the heart of Ottawa.
            </p>
