...
import { CalendarDays, UtensilsCrossed, Users, TrendingUp, Clock, ArrowUpRight, BarChart3, MapPin, Mail, Settings, FileText } from 'lucide-react';
import api from '../../api';
    ...
    <div className="space-y-8">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          { label: 'Email Templates', path: '/admin/email-templates', icon: FileText, desc: 'Edit email content' },
